          ...
          <div class="mb-3 row">
            ...
            <div class="col-lg-10 col-md-6 col-sm-12">
              <select name="category" class="form-control">
                <option value="tshirts" {{ $viewData['product']->getCategory() == 'tshirts' ? 'selected' : '' }}>T-Shirts</option>
                <option value="jackets" {{ $viewData['product']->getCategory() == 'jackets' ? 'selected' : '' }}>Jackets</option>
                <option value="bags" {{ $viewData['product']->getCategory() == 'bags' ? 'selected' : '' }}>Bags</option>
              </select>
            </div>
          </div>
        </div>
